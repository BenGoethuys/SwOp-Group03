...
public abstract class AbstractSystem {
    ...
    /**
     * CAN BE PUSHED DOWN IN HIERARCHY --> remove because only necessary in Subsystem
     *
     * This constructor is used for elements of the subclass Subsyste, since they  have a parent.
    ...
    /**
     * This constructor is used for all elements of type 'AbstracSystem', although possibly indirect.
     * @param version The versionID (of that type) of this element.
     * @param name The string name for this element.
     * @param description The string description of this element.
     * @throws NullPointerException if the versionID is null.
     ...
     * CAN BE PUSHED DOWN IN HIERARCHY --> remove because only necessary in Subsystem
     *
     * This is an abstract heading for the function that chekcs
     * the validity of the given name, in combination with its parent.
     ...
     * Only elements of subclass subsystems have a parent different from null.
     ...
     *
     * This is a getter for the parent of the AbstractSystem.
     * A project is it's own parent.
    ...
    /**
     * This method returns the head of the subsystem tree structure.
     * This is an element from the type Project and can be recognised by his self reference in getParent().
    ...
    /**
     * This method sets the child variable to the given child.
     * A child is of type Subsystem.
