...
public class Subsystem extends AbstractSystem {
    /**
     * This constructor makes an element of the class subsyste, using it's superclass, AbstracSystem, constructor.
     ...
     * **/
    public Subsystem(AbstractSystem parent, VersionID version, String name, String description) throws NullPointerException, InvalidArgumentException {
     ...
     * This is done recursively. To be correctly used, the function should be called the first time with the Project of the three.
    ...
    /**
     * This function checks or the given parent isn't one of subsystem's own childs
