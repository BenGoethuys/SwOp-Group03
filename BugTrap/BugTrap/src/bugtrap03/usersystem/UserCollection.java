...
public class UserCollection {
     ...
     */
    public UserCollection(T col) throws IllegalArgumentException {
        setCollection(col);
    }
    ...
    /**
     * Get the {@link HashMap} holding all the objects created of this type
     * using this collection. Basically, this has to return a static map that
     * will be used to hold all unique Identifiers used by add();
     *
     * @return
     */
     ...
     * @return Whether the given collection contains no two users with the same
     * username. false when col == null.
     */
    ...
    /**
     * Get whether the given {@link Collection} contains a {#link User} with
