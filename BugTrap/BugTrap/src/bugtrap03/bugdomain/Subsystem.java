...
public class Subsystem extends AbstractSystem {
     ...
     *             subsystem
     * @see AbstractSystem#AbstractSystem(AbstractSystem, VersionID, String,
     *      String)
     */
     ...
     *         <dd>if creationDate == null: result.getDate() == current date at
     *         the moment of initialization <br>
     *         <dt><b>Postconditions:</b>
     ...
     * <b>Only use with Caution</b>: No other changes will be made. (e.g no
     * dependencies or milestones will be changed.)
     *
