...
public class CreateProjectCmd implements Cmd<Project> {
     ...
     * <br>
     * a5. Ask user the lead developer by providing a list of
     * possibilities.
     * <br>
     * a6. Show the user the details of the created project.
     * <br>
     * b) Clone project (without BugReports)
     * <br>
     ...
     * @see DataModel#createProject(VersionID, String, String, GregorianCalendar, Developer, long, User)
     */
    private Project createProjectScenario(TerminalScanner scan, DataModel model, User user)
            throws CancelException, PermissionException, IllegalArgumentException {
	// Project name
	// a1. Ask user the name of the project
	...
	do {
		...
		projStartDate = new GregorianCalendar(Integer.parseInt(projDateStr[0]),
		        Integer.parseInt(projDateStr[1]) - 1, Integer.parseInt(projDateStr[2]));
	...
	// Create Project
	Project proj = model.createProject(new VersionID(), projName, projDesc, projStartDate, lead, projBudgetEstimate,
	        user);
     ...
     * @see GetProjectCmd#exec(TerminalScanner, DataModel, User)
     */
    private Project cloneProjectScenario(TerminalScanner scan, DataModel model, User user)
            throws CancelException, PermissionException, IllegalArgumentException {
	// b1. Ask user which project by providing a list of possibilities.
