...
public class DeclareAchievedMilestoneCmd implements Cmd<Project> {
    ...
    /**
     * <p>
     * <br> 1. The developer indicates that he wants to declare an achieved milestone.
     ...
     * <br><dd>5a. The developer indicates he wants to change the achieved milestone
     * of the entire project: The use case continues with step 6.</dd>
     * <br> 6. The system shows the currently achieved milestones and asks for a new one.
     ...
     * <br><dd>8a. The new achieved milestone could not be assigned due to some
