...
public class User {
	 ...
	 *             When any of the arguments is invalid.
	 ...
	 * @throws IllegalArgumentException
	 *             When the uniqueUsername is not valid.
	 * @see isValidUniqueUsername(String uniqueUsername)
	 */
	private void setUniqueUsername(String uniqueUsername) throws IllegalArgumentException {
		if (isValidUniqueUsername(uniqueUsername)) {
			...
			throw new IllegalArgumentException(
					"Unique username:" + uniqueUsername + " is not a valid unique username.");
		}
	}
	 ...
	 *            The new first name.
	 * @throws IllegalArgumentException
	 *             When the firstName is not valid.
	 * @see isValidFirstName(String firstName)
	 */
	 ...
	 *            The new middle name.
	 * @throws IllegalArgumentException
	 *             When the middleName is not valid.
	 * @see isValidmiddleName(String middleName)
	 */
	 ...
	 *            The new last name.
	 * @throws IllegalArgumentException
	 *             When the last name is not valid.
	 * @see isValidLastName(String lastName)
	 */
