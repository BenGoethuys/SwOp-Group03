...
public class ProposePatchCmdTest {
    ...
    /**
     * Get the questions in the default scenario with a given BugReport where the test added is equal to "patch over
     * here\npatch line 2"
     *
     * @return
     */
    ...
    /**
     * Get the answers in the default scenario with a given BugReport where the test added is equal to "patch over
     * here\npatch line 2"
     *
     * @return
     */
