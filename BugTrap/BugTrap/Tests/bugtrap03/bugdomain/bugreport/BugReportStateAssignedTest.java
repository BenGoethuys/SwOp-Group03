...
public class BugReportStateAssignedTest {
    ...
    public static void setUpBeforeClass() throws Exception {
        issuer = new Issuer("blaStateAssignedTest", "bla", "bla");
        depList = PList.<BugReport>empty();
        test = "This is a test";
        patch = "This is a patch";

        dev = new Developer("blaStateAssignedTest1", "Jan", "Smidt");
        lead = new Developer("blaStateAssignedTest2", "Jan", "Smidt");
        programer = new Developer("blaStateAssignedTest3", "Jos", "Smidt");
        tester = new Developer("blaStateAssignedTest4", "Jantje", "Smidt");
        admin = new Administrator("blaStateAssignedTest5", "bla", "hihi");
